...
const contract_address = "0x8cEaBC97c45D09674844a36F4b0e6e5673085C60";
...
const dApp = {
  ...
  copyrightWork: async function() {
    const name = $("#dapp-winenot-name").val();
    const vintage = $("#dapp-winenot-vintage").val();
    const varietal = $("#dapp-winenot-varietal").val();
    const appraisal = $("#dapp-winenot-appraisal").val();
    const origin = $("#dapp-winenot-origin").val();
    const producer = $("#dapp-winenot-producer").val();
  ...
  main: async function() {
    ...
    this.wineRegistryABI = await (await fetch("./WineRegistry.json")).json();

    this.contract = new window.web3.eth.Contract(
      this.wineRegistryABI,
      contract_address,
